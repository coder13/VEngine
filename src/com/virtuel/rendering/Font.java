...
public class Font {
	...
	static {
		try {
			FontImage = ImageIO.read(new FileInputStream("res/font/default.png"));
		} catch (FileNotFoundException e) {
			System.err.println("[net.va.util.Font] default font png found in res/font/default.png could not be found.");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
